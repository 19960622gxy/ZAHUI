...
//        Toast.makeText(this,"hahha",Toast.LENGTH_SHORT).show();
        ...
        Toolbar toolbar=(Toolbar) findViewById(R.id.xiaohua_toolbar);
...
//                Toast.makeText(this,"你点击了Delete",Toast.LENGTH_SHORT).show();
                UMImage thumb = new UMImage(XiaoHuaActivity.this, R.mipmap.app);//资源文件
                UMWeb web = new UMWeb("http://www.baidu.com");
                web.setTitle("杂烩");//标题
                web.setThumb(thumb);  //缩略图
                web.setDescription("混合的比较有营养");//描述
                //打开分享面板
                new ShareAction(XiaoHuaActivity.this)
                        .withMedia(web)
                        ...
                        .setCallback(new UMShareListener() {
                            ...
                            public void onCancel(SHARE_MEDIA share_media) {
                                Toast.makeText(XiaoHuaActivity.this,"取消分享",Toast.LENGTH_SHORT).show();
                            }
                        }).open();
                break;
//            case R.id.delete:
