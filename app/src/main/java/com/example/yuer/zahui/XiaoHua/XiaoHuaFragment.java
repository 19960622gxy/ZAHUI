...
//        //构建技术问答列表
        ...
        adapter  = new XiaoHuaRVAdapter(getContext(),resultList);
        ...
        OkGo.get(Api.XIAOHUA_HOST)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        Gson gson = new Gson() ;
                        XiaoHuaResponse xiaohuaResponse = gson.fromJson(s,XiaoHuaResponse.class);
                        List<XiaoHuaResponse.ResultBean.DataBean> data=xiaohuaResponse.getResult().getData();
